---
name: codex-research
description: Codex CLI로 반복 연구 루프를 운영합니다 — 목표 지향 실험을 자동으로 반복하고 결과를 기록합니다. "codex 연구", "codex research", "반복 연구", "연구 루프", "research loop", "자율 연구", "codex로 연구", "깊이 연구", "반복 실험", "autoresearch", "codex 루프", "계속 연구", "overnight research" 요청에 사용합니다. 단발 작업 위임은 hey-codex가 더 적합합니다.
