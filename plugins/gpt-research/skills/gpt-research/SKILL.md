...
Expected Output 섹션에서 GPT-PRO에게 다음 **구조화된 응답 포맷**을 요청합니다:

| 섹션 | 필수 | 내용 |
|------|------|------|
| **Summary** | O | 분석 결과 3줄 이내 핵심 요약 |
| **Findings** | O | 모드별 분석 본문 (파일 경로 + 라인 번호 포함) |
| **Code Suggestions** | △ | 코드 변경 제안 — 파일 경로, 라인, 변경 유형, 코드 블록 |
| **Action Items** | O | P0-Critical / P1-Important / P2-Suggestion 우선순위 체크리스트 |
| **References** | △ | 외부 참고 자료 |

이 포맷은 GPT-PRO 응답을 Claude Code에 붙여넣었을 때 바로 후속 작업을 수행할 수 있도록 설계되었습니다.
