...
> harness-spec.md: 10개 기능, iOS 26+, MVVM + @Observable
> features.json: F001-F010 (기본 5 + 차별화 5)
...
이 정보가 harness-spec.md "사용자 맥락" 섹션에 기록되어 Phase 1.5 -> 3 전체 과정의
...
### 6. evaluation-round-1.md로 구체적 수정 지침
